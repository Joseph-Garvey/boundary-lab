...
`pyproject.toml` pins the Metal-enabled fork `v0.2.1` wheel URL and SHA-256, so ordinary installation
...
The release is [v0.2.1](https://github.com/Joseph-Garvey/BEAT_Engine/releases/tag/v0.2.1).
...
```text
python -m pip install --force-reinstall --no-deps "beat-engine @ https://github.com/Joseph-Garvey/BEAT_Engine/releases/download/v0.2.1/beat_engine-0.2.1-py3-none-any.whl#sha256=7153c9b45c3c258ad45b59f97d86969edb4394ebac22e36813cc25fae29bc3e1"
```
